/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 63862398fa15aa77c0f39abc2cd68b73)
// Runtime types generated with workerd@1.20260611.1 2026-06-12 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	LOGOS: KVNamespace;
	DB: D1Database;
	ASSETS: Fetcher;
	DATABASE_URL: string;
	WORKER_SELF_REFERENCE: Fetcher /* invoice-creator */;
}
